...
{
    public partial class LooseForm : Form
    {
        public LooseForm()
        {
            InitializeComponent();
        ...
        private void ChangeTopic()
        {
            ...
            labelLoose.ForeColor = FormMenu.light ? Color.FromArgb(50, 50, 100) : Color.FromArgb(200, 200, 255);
            labelThreeMistakes.ForeColor = FormMenu.light ? Color.FromArgb(50, 50, 100) : Color.FromArgb(200, 200, 255);
        ...
        {
            labelLoose.Text = FormMenu.ukrLang ? "Поразка(" : "Проигрыш(";
            labelThreeMistakes.Text = FormMenu.ukrLang ? "У вас 3 помилки" : "У вас 3 ошибки";
        ...
        private void LooseForm_Load(object sender, EventArgs e)
        {
            ChangeLanguage();
            ChangeTopic();
